...
if __name__ == "__main__":
    ...
    parser.add_argument("--path_to_data", "-dp", type=str, default="/home/abhinavchadaga/cs/fri_II/final_project/data/elevator_panels")
    parser.add_argument("--save_path", "-sp", type=str, default="/home/abhinavchadaga/cs/fri_II/final_project/datasets/elevator_panels")
    ...
    cprint(f"buildings:", color="cyan", attrs=["bold"])
    for b in buildings:
        print(b)
    print("\n")
    ...
    for building in buildings:
        ...
        for img in annos.values():
            ...
            for m in img["regions"]:
                s_attr = m["shape_attributes"]
                r_attr = m["region_attributes"]
